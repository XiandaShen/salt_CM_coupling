...
voidr1=plot(time,voidr(:,5),'r-');
hold on 
voidr2=plot(time,voidr(:,10),'g-');
hold on 
voidr3=plot(time,voidr(:,15),'y-');
hold on 
voidr4=plot(time,voidr(:,20),'b-');
hold on 
voidr5=plot(time,voidr(:,25),'m-');
hold on 
voidr6=plot(time,voidr(:,30),'r--');
hold on 
voidr7=plot(time,voidr(:,35),'g--');
hold on 
voidr8=plot(time,voidr(:,40),'y--');
hold on 
voidr9=plot(time,voidr(:,45),'b--');
hold on 
voidr10=plot(time,voidr(:,50),'m--');
hold on 
xlabel('Time(s)','fontsize',16)
ylabel('Void radious(mm)','fontsize',16)
legend([voidr1,voidr2,voidr3,voidr4,voidr5,voidr6,voidr7,voidr8,voidr9,voidr10],'cell5','cell10','cell15','cell20','cell25','cell30','cell35','cell40','cell45','cell50','Location','northwest')
...
celle1=plot(time,celle(:,5),'r-');
hold on 
celle2=plot(time,celle(:,10),'g-');
hold on 
celle3=plot(time,celle(:,15),'y-');
hold on 
celle4=plot(time,celle(:,20),'b-');
hold on 
celle5=plot(time,celle(:,25),'m-');
hold on 
celle6=plot(time,celle(:,30),'r--');
hold on 
celle7=plot(time,celle(:,35),'g--');
hold on 
celle8=plot(time,celle(:,40),'y--');
hold on 
celle9=plot(time,celle(:,45),'b--');
hold on 
celle10=plot(time,celle(:,50),'m--');
hold on 
xlabel('Time(s)','fontsize',16)
 ylabel('Principal strain','fontsize',16)
% ylabel('Vertical strain','fontsize',16)
legend([celle1,celle2,celle3,celle4,celle5,celle6,celle7,celle8,celle9,celle10],'cell5','cell10','cell15','cell20','cell25','cell30','cell35','cell40','cell45','cell50','Location','northwest')
...
cells1=plot(time,cells(:,5),'r-');
hold on 
cells2=plot(time,cells(:,10),'g-');
hold on 
cells3=plot(time,cells(:,15),'y-');
hold on 
cells4=plot(time,cells(:,20),'b-');
hold on 
cells5=plot(time,cells(:,25),'m-');
hold on 
cells6=plot(time,cells(:,30),'r--');
hold on 
cells7=plot(time,cells(:,35),'g--');
hold on 
cells8=plot(time,cells(:,40),'y--');
hold on 
cells9=plot(time,cells(:,45),'b--');
hold on 
cells10=plot(time,cells(:,50),'m--');
hold on 
xlabel('Time(s)','fontsize',16)
 ylabel('Principal stress','fontsize',16)
% ylabel('Vertical stress(MPa)','fontsize',16)
legend([cells1,cells2,cells3,cells4,cells5,cells6,cells7,cells8,cells9,cells10],'cell5','cell10','cell15','cell20','cell25','cell30','cell35','cell40','cell45','cell50','Location','southwest')

% curves for Global porosity
figure('Name','Global porosity','NumberTitle','off')    
globalp1=plot(time,globalp,'r-');
xlabel('Time(s)','fontsize',16)
...
globalpe1=plot(time,globalve,'r-');
xlabel('Time(s)','fontsize',16)
