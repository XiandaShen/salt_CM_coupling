function []=supercurvecase2(creepinterval,cellnumber,j,cellr,thick,epsilon,sigma,totalp)
% cellnumber=50;
ctime=j-1;
ftime=1:1:ctime;
...
saveas(gcf,'../case2globalch1e.png');
...
saveas(gcf,'../case2globalch2e.png');
