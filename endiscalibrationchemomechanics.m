function [FF1]=endiscalibrationchemomechanics(creepinterval,j,itnum,cellnumber,cellr,Q,thick,dHdL,dsigma,dtsigma,sigma,depsilon,epsilon,tepsilon,epsilone,depsilone,dvcepsilon,totalp,dinter,xx1,muo,DSs)
...
dtepsilon=zeros(3,3);
dtepsilon(3,3)=xx1(cellnumber*6+1);
