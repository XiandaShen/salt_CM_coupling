...
tic
DSs=6;
cellnumber=400; % number of cells in REV
...
time=toc;
save('case9time.mat','time');
save('case9totalp.mat','totalp');
save('case9sigma.mat','sigma');
save('case9epsilon.mat','epsilon');
save('case9thick.mat','thick');


% supercurvecase9(creepinterval,cellnumber,j,cellr,thick,epsilon,sigma,totalp)
