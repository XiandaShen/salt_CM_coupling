...
% chemomechanics
 [F1,totalp,tepsilon,dinter,dsigma,sigma,depsilon,epsilon,epsilone,cellr,thick,dvcepsilon]=encalibrationchemomechanics(creepinterval,j,itnum,cellnumber,cellr,Q,thick,dHdL,dsigma,dtsigma,sigma,depsilon,epsilon,tepsilon,epsilone,depsilone,dvcepsilon,totalp,dinter,x1,muo,DSs);
...
disa=disa+0.05;
    ...
    iteralpha=0;
    invBFGS=eye(6*cellnumber+1);
     [F1]=endiscalibrationchemomechanics(creepinterval,j,itnum,cellnumber,cellr,Q,thick,dHdL,dsigma,dtsigma,sigma,depsilon,epsilon,tepsilon,epsilone,depsilone,dvcepsilon,totalp,dinter,x1,muo,DSs);
testdis=1;
pk=-invBFGS*F1;
end
...
%[Fnew,totalp,tepsilon,dinter,dsigma,depsilon,epsilon,cella,cellb,cellc,thick]=puremechanics(j,itnum,cellnumber,cella,cellb,cellc,thick,dsigma,dtsigma,depsilon,epsilon,tepsilon,totalp,dinter,xnew);
 % chemomechanics
 [Fnew,totalp,tepsilon,dinter,dsigma,sigma,depsilon,epsilon,epsilone,cellr,thick,dvcepsilon]=encalibrationchemomechanics(creepinterval,j,itnum,cellnumber,cellr,Q,thick,dHdL,dsigma,dtsigma,sigma,depsilon,epsilon,tepsilon,epsilone,depsilone,dvcepsilon,totalp,dinter,xnew,muo,DSs);
...
time=toc;
save('../case7time.mat','time');
save('../case7totalp.mat','totalp');
save('../case7sigma.mat','sigma');
save('../case7epsilon.mat','epsilon');
save('../case7thick.mat','thick');


supercurvecase7(creepinterval,cellnumber,j,cellr,thick,epsilon,sigma,totalp)
